...
exports.acharBio = acharBio;
exports.apagarItem = apagarItem;
exports.acharBioFuncional = acharBioFuncional;
exports.acharNomeFuncional = acharNomeFuncional;
exports.lista = [
...
function apagarItem(id) {
    let index;
    for (let i = 0; i < exports.lista.length; i++) {
        if (exports.lista[i]['id'] === id) {
            index = i;
        }
    }
    exports.lista.splice(index, 1);
}
//d) Crie uma função que altere a bio ou o name a partir de um id passado
function alterarItem(id, campo, novoValor) {
    let index = exports.lista.findIndex(item => item['id'] === id);
    exports.lista[index][campo] = novoValor;
}
